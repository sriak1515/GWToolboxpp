...
└── Scripting (INTERFACE library, linked into all plugins)
    ├── Action system     — 46 action types (what scripts do)
    ├── Condition system  — 57 condition types (when scripts run)
...
| [03-actions.md](03-actions.md) | All 46 action types with parameters |
| [04-conditions.md](04-conditions.md) | All 57 condition types with parameters |
