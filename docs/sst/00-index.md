...
└── Scripting (INTERFACE library, linked into all plugins)
    ├── Action system     — 47 action types (what scripts do)
    ├── Condition system  — 58 condition types (when scripts run)
...
| [03-actions.md](03-actions.md) | All 47 action types with parameters |
| [04-conditions.md](04-conditions.md) | All 58 condition types with parameters |
